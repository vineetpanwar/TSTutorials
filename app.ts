...
import { Book , DamangeLogger, Librarian , Magazine} from './iterfaces';
import {UniversityLibrarian, ReferenceItem , Encyclopedia ,Employee ,Researcher} from './classes';
import { Purge, MaxBooksAllowed} from "./utilityFunctions";
import Shelf from "./shelf"; 
import {MeetingResource} from "./models/MeetingResource"
import {ConferenceRoom ,conferenceRoomsData} from "./models/conferenceRoom"
import {Building , buildingData} from "./models/building"
import {PartyTent,partyTentsData} from "./models/partyTent"
...
async function awaitedResponse(){
        let found = await getDelayedResponse(2.5);
}
       
        awaitedResponse().catch(e =>  console.log(e));
